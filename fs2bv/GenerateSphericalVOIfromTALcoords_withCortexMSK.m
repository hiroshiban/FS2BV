function voi=GenerateSphericalVOIfromTALcoords_withCortexMSK(SRF_dir,center_tal_XYZ,radius_mm,voinames,output_coordinate,voicolors,save_name,prefix_srf,srf_params,vmr_params,VMRdim)

% Generates spherical VOIs in TAL space, and masks them with a cortex mask.
% function GenerateSphericalVOIfromTALcoords_withCortexMSK(SRF_dir,center_tal_XYZ,radius_mm,voinames,:output_coordinate,:voicolors,:save_name,:prefix_srf,:srf_params,:vmr_params,:VMRdim)
% (: is optional)
%
...
% >> SRF_dir='/HB/3d/';
% >> voi=GenerateSphericalVOIfromTALcoords_withCortexMSK(SRF_dir,center_tal_XYZ,5,voinames,'TAL',[],save_name,'*RECOSM');
%
% [input]
...
% Last Update: "2020-03-30 17:22:09 ban"
